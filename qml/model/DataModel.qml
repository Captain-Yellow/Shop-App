...
Item {
    ...
    // whether a user is registerred
    readonly property bool userRegistered: _.userRegistered
    ...
    Connections {
        ...
        onShowProduct: {
            ...
            navigation.currentNavigationItem.navigationStack.push(Qt.resolvedUrl("../pages/AddPage.qml"))
        ...
        onRegister: {
            ...
            navigation.currentNavigationItem.navigationStack.push(Qt.resolvedUrl("../pages/Register.qml"))
        }
